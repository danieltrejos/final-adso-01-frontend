                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input id="isbn" name="isbn" placeholder="978-3-16-148410-0" value={formData.isbn} onChange={handleChange} required />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="name">Nombre</Label>
                                <Input id="name" name="name" placeholder="Ingrese el nombre del libro" value={formData.name} onChange={handleChange} required />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={formData.publisherId} onValueChange={(value) => handleSelectChange("publisherId", value)}>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input id="yearPublished" name="yearPublished" type="number" placeholder="2023" value={formData.yearPublished} onChange={handleChange} required />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="numPages">Número de Páginas</Label>
                                <Input id="numPages" name="numPages" type="number" placeholder="250" value={formData.numPages} onChange={handleChange} required />
                            </div>
                        </div>
